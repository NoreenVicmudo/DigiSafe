                ...
                <div class="menu-search-container">
                    ...
                    <div class="menu-container">
                        <ul id="menu">
                            ...
                            <li>
                                <a href="#" class="next-page">QR Code</a>
                            </li>
                            <li>
        ...
        <div class="container mt-3">
            <div class="table-container"> <!-- Wrapper for scrolling -->
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                            $sql = "SELECT * FROM qrcode ORDER BY TimeGenerated DESC";
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td>" . htmlspecialchars($row['GeneratedByUserID']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['LockerID']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['TimeGenerated']) . "</td>";
                                echo "<td>" . htmlspecialchars($row['TimeExpired']) . "</td>";
