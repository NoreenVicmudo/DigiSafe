...
<body>
    ...
    <div class="content">
                ...
                <div class="menu-search-container">
                    ...
                    <div class="menu-container">
                        <ul id="menu">
                            ...
                            <li>
                                <a href="#" class="next-page">Customer</a>
                            </li>
                            <li>
        ...
        <div id="sidebar">
            <div class="sidebar-links">
                ...
                <a class="sidebar" href="#">Customer</a>
            </div>
        ...
        <div class="container mt-3">
            <div class="table-container"> <!-- Wrapper for scrolling -->
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT * FROM support ORDER BY TimeSent DESC";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<td>" . htmlspecialchars($row['TimeSent']) . "</td>";
                                echo "<td>
    ...
    <script>
        ...
        // Handle Show Concern popups (Multiple rows)
